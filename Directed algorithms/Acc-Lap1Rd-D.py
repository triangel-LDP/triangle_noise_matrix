...
for eps in epsilon_list:
    ...
    print("Acc-Lap1Rd-D:", 'MSE:', se, '     MRE:', re)


print(epsilon_list)
print("Acc-Lap1Rd-D:MSE:", MSE1)
print("Acc-Lap1Rd-D:MRE:", MRE1)
